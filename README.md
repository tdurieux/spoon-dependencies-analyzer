[![Build Status](https://travis-ci.org/tdurieux/spoon-dependencies-analyzer.svg?branch=master)](https://travis-ci.org/tdurieux/spoon-dependencies-analyzer) [![Coverage Status](https://coveralls.io/repos/github/tdurieux/spoon-dependencies-analyzer/badge.svg?branch=master)](https://coveralls.io/github/tdurieux/spoon-dependencies-analyzer?branch=master)
