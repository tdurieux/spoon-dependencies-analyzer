java -jar target/DependencyAnalyzer-0.0.1-SNAPSHOT.jar ../VLille/src -f txt -l class > examples/vlille-DependencyAnalyser.c2c
java -jar target/DependencyAnalyzer-0.0.1-SNAPSHOT.jar ../VLille/src -f dot -l class > examples/vlille-DependencyAnalyser.c2c.gv
java -jar target/DependencyAnalyzer-0.0.1-SNAPSHOT.jar ../VLille/src -f txt -l package > examples/vlille-DependencyAnalyser.p2p
java -jar target/DependencyAnalyzer-0.0.1-SNAPSHOT.jar ../VLille/src -f dot -l package > examples/vlille-DependencyAnalyser.p2p.gv

java -jar target/DependencyAnalyzer-0.0.1-SNAPSHOT.jar ./src -f txt -l class > examples/dependencyAnalyser-DependencyAnalyser.c2c
java -jar target/DependencyAnalyzer-0.0.1-SNAPSHOT.jar ./src -f dot -l class > examples/dependencyAnalyser-DependencyAnalyser.c2c.gv
java -jar target/DependencyAnalyzer-0.0.1-SNAPSHOT.jar ./src -f txt -l package > examples/dependencyAnalyser-DependencyAnalyser.p2p
java -jar target/DependencyAnalyzer-0.0.1-SNAPSHOT.jar ./src -f dot -l package > examples/dependencyAnalyser-DependencyAnalyser.p2p.gv
